...
<!-- miine-->
  ...
  <body class="backgroundc">
    ...
    <div class="container" >
      <div class="row">
      	<a href="newpost.php" style="color: white;font-size: 25px;padding-left: 1000px;"><strong><i>Write a blog!</i></strong></a>
        <div class="col-lg-8">
          <div class="container-fluid">
          	<br /><br />
          	
          	<span style="font-size: 55px;color: white;margin-right:800px;"><strong><u>BlogSpot</u></strong></span>
          <br /><br />
				...
				?>
				 <div class="panel panel-primary" style="margin-top:100px;width: 1000px;">
              ...
              <div class="panel-body" style="overflow-y: scroll;overflow-x:hidden">
                  ...
                  <span style="padding-left: 700px;font-size: 20px;"><strong><?php echo $date; ?></strong></span>
                  	...
                  	<form method="post" action="viewpost.php">         	
	                  	...
	                  	<button type="submit" class="btn btn-primary button" id="ChatTextSubmit" style="margin-top: 10px;margin-left: 4px;width: 500px;font-size: 30px;">Read More</button>
                  </form></p>
             </div>
            </div>
              			<?php
